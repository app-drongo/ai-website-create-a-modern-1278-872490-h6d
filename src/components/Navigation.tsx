...
// Generated: 2025-09-14T02:11:12.432Z
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl text-foreground">Coastal Retreats</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button size="sm" className="bg-primary hover:bg-primary/90 text-background group">
              Book Trip
              <MapPin className="ml-2 size-4 transition-transform group-hover:scale-110" />
            </Button>
          </div>

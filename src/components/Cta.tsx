...
export default function Cta() {
  const stats = [
    ...
    { value: "24/7", label: "Concierge Support", icon: Calendar }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Skip the crowded hotels and impersonal booking sites. Choose Coastal Retreats for 
                personalized luxury accommodations with unmatched beachfront access and concierge service.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Licensed & insured luxury vacation rental specialists
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Personal assistance for dining, activities, and local experiences
              </p>
            </div>
          </div>
        </div>
